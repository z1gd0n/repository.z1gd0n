...
# edited base link. removed forward slash from search links because the slash is in the base link. 
# might need to change that later if it doesn't work. 12102017

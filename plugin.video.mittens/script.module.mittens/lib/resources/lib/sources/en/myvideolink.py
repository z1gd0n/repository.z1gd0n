...
# added the bypass link to enter the website by adding "get" and https. 12102017
...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.domains = ['newmyvideolink.xyz', 'beta.myvideolinks.xyz', 'videolinks.ga', 'myvideolinks.ga', 'ezfile.xyz', 'newmyvideolinks.ga', 'http://newmyvideolink.xyz']
        self.base_link = 'https://get.newmyvideolink.xyz/'

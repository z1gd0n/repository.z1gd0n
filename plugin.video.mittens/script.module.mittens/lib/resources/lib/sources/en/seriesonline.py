...
# site redirects to a legal notice. 12102017
# added new url and search link 2. 12102017
...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.domains = ['123movieshd.tv', 'seriesonline.is', '0123movies.com']
        self.base_link = 'http://0123movies.com'

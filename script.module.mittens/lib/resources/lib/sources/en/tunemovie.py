...
# url for tunemovie is dead. added new url, but keeping scraper name. 12102017
...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.domains = ['tunemovies.to', 'tunemovie.tv', 'movietube.top']
        self.base_link = 'http://movietube.top'

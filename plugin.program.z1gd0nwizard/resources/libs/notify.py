...
def firstRunSettings():
	class firstRun(xbmcgui.WindowXMLDialog):
		...
		def onInit(self):
			...
			self.thumbs     = 313
			self.showdialog()
			self.controllist     = [ self.skin, self.trakt, self.debrid, self.login, 
			...
			self.controlsettings = ['keepskin', 'keeptrakt', 'keepdebrid', 'keeplogin',
...
def firstRun():
	...
	fr = MyWindow( "" , ADDON.getAddonInfo('path'), 'DefaultSkin')

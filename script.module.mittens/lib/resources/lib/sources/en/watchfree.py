...
# updated url  and search link. 12102017
...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.domains = ['watchfree.to','watchfree.unblockall.org','watchfrees.unblockall.org']
        self.base_link = 'https://watchfrees.unblockall.org/'
